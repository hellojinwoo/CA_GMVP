...
def split_dataset(file_path):
    ...
    global daily_return_df_list_val
    global daily_return_df_list_test
    ...
    return daily_return_df_list_val, daily_return_df_list_test